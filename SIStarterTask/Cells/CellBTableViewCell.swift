...
class CellBTableViewCell: UITableViewCell {
    
    // MARK: - Views
    
    private let cellContentView = CellBContentView()
    ...
    func configureCell(with viewModel: CellBContentViewModel?) {
